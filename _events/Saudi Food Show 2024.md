...
description: ""
---
<p>Singapore Food Manufacturers’ Association and Enterprise Singapore are proud to lead 8 Singapore companies to exhibit under the Singapore pavilion at the Saudi Food Show 2024, which is one of the leading trade show in Middle East.</p>
...
<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
	<div class="sgds-card-booth">
		<p style="text-transform: uppercase;">
			<small>
				<strong>Singapore Pavilion - Booth No: A2-26</strong>
			</small>
		</p>
	</div>
...
<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
	<div class="sgds-card-booth">
		<p style="text-transform: uppercase;">
			<small>
				<strong>Singapore Pavilion - Booth No: B2-27</strong>
			</small>
		</p>
	</div>
	<div style="margin-top: 15px" class="sgds-card-image">
...
<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
	<div class="sgds-card-booth">
		<p style="text-transform: uppercase;">
			<small>
				<strong>Singapore Pavilion - Booth No: B2-29</strong>
			</small>
		</p>
	</div>
	<div style="margin-top: 15px" class="sgds-card-image">
...
<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
	<div class="sgds-card-booth">
		<p style="text-transform: uppercase;">
			<small>
				<strong>Singapore Pavilion - Booth No: B2-25</strong>
			</small>
		</p>
	</div>
	<div style="margin-top: 15px" class="sgds-card-image">
...
<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
	<div class="sgds-card-booth">
		<p style="text-transform: uppercase;">
			<small>
				<strong>Singapore Pavilion - Booth No: B2-31</strong>
			</small>
		</p>
	</div>
	<div style="margin-top: 15px" class="sgds-card-image">
...
<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
	<div class="sgds-card-booth">
		<p style="text-transform: uppercase;">
			<small>
				<strong>Singapore Pavilion - Booth No: A2-28</strong>
			</small>
		</p>
	</div>
	<div style="margin-top: 15px" class="sgds-card-image">
...
<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
	<div class="sgds-card-booth">
		<p style="text-transform: uppercase;">
			<small>
				<strong>Singapore Pavilion - Booth No: A2-30</strong>
			</small>
		</p>
	</div>
	<div style="margin-top: 15px" class="sgds-card-image">
