...
<div style="display: flex; flex-wrap: wrap;">
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		...
		<div class="flex-paragraph">
			...
			<p>Naturally brewed from the traditional recipe, no artificial flavouring or colorings, rich and subtle aroma, 3-MCPD not detected.</p>
		</div>
	</div>
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
		...
		<div class="flex-paragraph">
			...
			<p>Tai Hua reduced salt light soy sauce contains 35% lower sodium than regular light soy sauce.  It is a traditional Chinese-flavoured soy sauce, naturally brewed from selected premium ingredients.</p>
		</div>
	</div>
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
		...
		<div class="flex-paragraph">
			...
			<p>Naturally brewed from the traditional recipe, no artificial flavouring or colourings, rich and subtle aroma, 3-MCPD not detected.</p>
		</div>
	</div>
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
		...
		<div class="flex-paragraph">
			...
			<p>Tai Hua seafood soy sauce is an ideal soy sauce for steamed seafood such as fish, crab, cuttlefish and prawns.  It is 25% lower in sodium as compared to regular light soy sauce, is a healthier condiment.</p>
		</div>
	</div>
</div>