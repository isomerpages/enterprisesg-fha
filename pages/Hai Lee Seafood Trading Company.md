---
title: Hai Lee Seafood Trading Company
permalink: /hai-lee-seafood-trading-company/
variant: markdown
description: ""
---
<div class="flex-paragraph">
	<div style="display: flex; flex-wrap: wrap;" class="flex-container">
		...
		<div style="flex: 1 1 58%; display: block; margin-left: 3px" class="card-sgds">
			...
			<p>We are a seafood processing and trading company.</p>
			<p><a target="_blank" href="https://www.haileeseafood.com.sg">www.haileeseafood.com.sg</a></p>
		</div>
	</div>
</div>
	...
	<div style="flex: 1 1 35%; padding: 10px; display: block; background-color: maroon; border-radius: 25px; align-self: center;" class="card sgds">
		...
		<div class="flex-paragraph">
			<p style="padding: 10px; color: white;">
				<b>Chia Fu Hai</b>
				<br>Director<br>+65 9389 3676<br>
				<a style="color: white;" href="mailto:chia.fuhai@haileeseafood.com.sg">chia.fuhai@haileeseafood.com.sg</a>
			</p>
		</div>
	</div>
</div>
...
<div style="display: flex; flex-wrap: wrap;">
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		...
		<div class="flex-paragraph">
			...
			<p>Cooked Crab, Crab Claw, Live Crab</p>
		</div>
	</div>
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
		...
		<div class="flex-paragraph">
			...
			<p>Barramundi Fillet, Seabass Whole</p>
		</div>
	</div>
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
		...
		<div class="flex-paragraph">
			...
			<p>Cut Squid, Squid Ring, Whole Squid</p>
		</div>
	</div>
	<div style="flex: 1 1 47%; margin: 10px; display: block;" class="card sgds">
		<div style="display: block;" class="flex-image">
		...
		<div class="flex-paragraph">
			...
			<p>Crayfish Whole, Crayfish Meat, Crayfish Half Cut</p>
		</div>
	</div>
</div>