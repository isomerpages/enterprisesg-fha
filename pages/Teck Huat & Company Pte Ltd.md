...
<head>
	<div class="flex-paragraph">
		...
		<p style="text-transform: uppercase">6l2-01</p></div>
			...
			<div class="card sgds" style="flex: 1 1 40%; display: block;"><img src="https://drive"></div>
	<div class="card-sgds" style="flex: 1 1 58%; display: block; margin-left: 3px">
		...
		<p><a href="https://www." target="_blank"><!--insert the www website link here (no need for https)-->www.</a></p>
	</div>
</div>
</head>
