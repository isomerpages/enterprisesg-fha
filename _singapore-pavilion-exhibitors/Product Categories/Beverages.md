...
<div style="display: flex; flex-wrap: wrap; padding: 10px">
	...
	<div class="card sgds" style="flex: 1 1 47%; margin: 10px; display: block;">
      ...
      <div class="sgds-card-content">
				<figure class="sgds-content" style="display: flex;justify-content: center;flex-direction: column;">
					<!-- Insert the exhibitor name... -->
          <p style="text-transform: uppercase;"><strong>[NEW!] jia jia singapore manufacturing pte ltd</strong></p>
				</figure>
				<!--...and description. -->
				<p><small>Manufacturer of authentic asian beverages</small></p>
				<!--Insert the exhibitor Isomer page link between the href="".-->
          <p><a href="/jiajiasg" target="_blank"><small>Visit their page</small></a></p>
      </div>
  </div>
	<div class="card sgds" style="flex: 1 1 47%; margin: 10px; display: block;">
		<div class="sgds-card-booth">
  ...
  </div> [Insert next line after this]
		<div class="card sgds" style="flex: 1 1 47%; margin: 10px; display: block;">
		<div class="sgds-card-booth">
		</div>
      <div class="sgds-card-image" style="margin-top: 15px">
